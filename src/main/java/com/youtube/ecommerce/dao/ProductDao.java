...
public interface ProductDao extends JpaRepository<Product,Long> {
    ...
    List<Product> findProductsWithKey(@Param("productName") String productName, @Param("productDescription") String productDescription, @Param("categoryId") Long categoryId, Pageable pageable);
